	...
	<main class="content" id="app">
        ...
        <div class="row">
            ...
            <div class="col-3">
                ...
                <input type="text" class="form-control" v-model="phone_number" id="phone_2" placeholder="Phone Number">
            </div>
            <div class="col-3">
        ...
        <div class="row">
            <div class="col-6">
                ...
                <input type="text" class="form-control" v-model="installment_month" id="installment_month" placeholder="Installment Month">
            </div>
            <div class="col-6">
