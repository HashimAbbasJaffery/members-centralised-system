        ...
        const app = Vue.createApp({
            data() {
                return {
                    ...
                    finalStep: 3,
                    children: 0,
                    file_number: "{{ $introletter->file_number }}",
            ...
            methods: {
                getData() {
                    return {
                        introletter: parseInt(route().params.introletter),
                ...
                async submit() {
                    try {
                        const response = await axios.put(route("api.introletter.update", this.getData()));
